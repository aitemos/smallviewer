...
//    private RoomModel $room;
        ...
        protected function body(): string {
            ...
            if ($this->state === self::STATE_REPORT_RESULT) {
                if ($this->result === self::RESULT_SUCCESS) {
                    return $this->m->render("reportSuccess", ["data"=>"Employee deleted successfully","href"=>"./"]);
                } else {
                    return $this->m->render("reportFail", ["data"=>"Employee delete failed. Please contact adiministrator or try again later.","href"=>"./"]);
                }
            }}else{
                $this->m->render("reportFail",["data"=>"you're not admin","href"=>"./"]);
            }
